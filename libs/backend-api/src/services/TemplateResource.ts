...
export class TemplateResource {
	 ...
	 * @throws ApiError
	 */
	public static postTemplate({ requestBody }: { requestBody?: TemplateCreateModel }): CancelablePromise<any> {
	 ...
	 * @throws ApiError
	 */
	public static getTemplateByKey({ key }: { key: string }): CancelablePromise<TemplateModel> {
		return __request(OpenAPI, {
			method: 'GET',
	 ...
	 * @throws ApiError
	 */
	public static deleteTemplateByKey({ key }: { key: string }): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: 'DELETE',
			url: '/umbraco/management/api/v1/template/{key}',
			path: {
