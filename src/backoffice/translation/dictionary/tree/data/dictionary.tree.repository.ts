...
export class UmbDictionaryTreeRepository implements UmbTreeRepository {
	#host: UmbControllerHostInterface;
	#dataSource: DictionaryTreeServerDataSource;
	...
	constructor(host: UmbControllerHostInterface) {
		...
		this.#dataSource = new DictionaryTreeServerDataSource(this.#host);
