...
@customElement('umb-stylesheets-sidebar-menu-item')
export class UmbStylesheetsSidebarMenuItemElement extends UmbLitElement {
	@state()
	...
	render() {
		return html`<umb-tree-item
			label="Stylesheets"
			icon="umb:folder"
			entity-type="stylesheet"
			@show-children=${this._onShowChildren}
			@hide-children=${this._onHideChildren}
			has-children>
			${this._renderTree ? html`<umb-tree alias="Umb.Tree.Stylesheets"></umb-tree>` : nothing}
		</umb-tree-item> `;
	}
}

export default UmbStylesheetsSidebarMenuItemElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-stylesheets-sidebar-menu-item': UmbStylesheetsSidebarMenuItemElement;
	}
}
