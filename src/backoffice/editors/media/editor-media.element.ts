...
import '../shared/editor-node/editor-node.element';
		...
		const dashboards: Array<ManifestWithLoader<ManifestEditorView>> = [
			{
				...
				loader: () => import('../shared/editor-node/views/edit/editor-view-node-edit.element'),
				weight: 200,
				meta: {
			...
			},
			{
				...
				loader: () => import('../shared/editor-node/views/info/editor-view-node-info.element'),
				weight: 100,
				meta: {
					editors: ['Umb.Editor.Media'],
					label: 'Info',
